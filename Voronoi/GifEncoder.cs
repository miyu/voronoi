...
namespace Voronoi
{
    ...
    public class GifEncoder : IDisposable
    {
        ...
        /// </param>
        public void AddFrame(Bitmap image, TimeSpan delay)
        {
            using (MemoryStream gifStream = new MemoryStream())
            {
                ...
                this.WriteGraphicControlBlock(gifStream, Convert.ToInt32(delay.TotalMilliseconds / 10F));
                this.WriteImageBlock(gifStream, !this.isFirstImage, 0, 0, image.Width, image.Height);
            }
